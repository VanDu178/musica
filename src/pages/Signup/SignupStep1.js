        ...
        <div className="signup-container">
            <div className="signup-box">
                ...
                <div className="text-start">
                    <label className="form-label fw-bold text-start" style={{ fontSize: "1rem" }}>
                ...
                <div className="text-start">
                    <a href="#" className="phone-link">{t("signup.usePhoneInstead")}</a>
                </div>
                ...
                <hr style={{ width: "100%", borderTop: "2px solid #FFFFFF", margin: "20px 0" }} />

                <div className="text-center mt-2" style={{ width: "100%" }}>
                    <span style={{ opacity: 0.6 }}>{t("signup.haveAccount")} </span>
                    <a href="/login" className="text-light">{t("signup.login")}</a>
                </div>
            </div>
        </div>
    );
