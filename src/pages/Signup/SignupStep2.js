  ...
  return (
    <div className="signup-step-2">
      ...
      <div className="password-rules">
        ...
        <ul>
          <li>
            {rules.hasLetter ? "✔" : "○"} {t("signupStep2.ruleHasLetter")}
          </li>
          <li>
            {rules.hasNumberOrSpecial ? "✔" : "○"}{" "}
            {t("signupStep2.ruleHasNumberOrSpecial")}
          </li>
          <li>
            {rules.hasMinLength ? "✔" : "○"} {t("signupStep2.ruleHasMinLength")}
          </li>
        </ul>
      </div>
      ...
      <button
        ...
        onClick={onNext}
        disabled={
          !rules.hasLetter || !rules.hasNumberOrSpecial || !rules.hasMinLength
        }
      >
